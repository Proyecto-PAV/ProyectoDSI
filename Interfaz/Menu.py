...
class Ui_MenuRV(object):
    ...
    def setupUi(self, MenuRV):
        ...
        self.lbl_usuario_logueado.setGeometry(QtCore.QRect(600, 40, 111, 20))
        self.lbl_usuario_logueado.setText("")
        self.lbl_usuario_logueado.setObjectName("lbl_usuario_logueado")
        self.lbl_nombre_sede = QtWidgets.QLabel(MenuRV)
        self.lbl_nombre_sede.setGeometry(QtCore.QRect(600, 10, 111, 16))
        self.lbl_nombre_sede.setText("")
        self.lbl_nombre_sede.setObjectName("lbl_nombre_sede")
        self.lbl_fecha = QtWidgets.QLabel(MenuRV)
        self.lbl_fecha.setGeometry(QtCore.QRect(600, 70, 111, 20))
        self.lbl_fecha.setText("Fecha: " + datetime.strftime(datetime.now(), "%d.%m.%y"))
        ...
        self.lbl_hora = QtWidgets.QLabel(MenuRV)
        self.lbl_hora.setGeometry(QtCore.QRect(600, 100, 111, 16))
