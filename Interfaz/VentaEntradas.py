...
#https://www.youtube.com/watch?v=-fMfKKvEPUs
...
class Ui_RegistrarVentaDeEntradas(object):
    ...
    def __init__(self, pantallaVentaEntradas):
    ...
    def confirmar(self):
        ...
        tipo_entrada = (self.tableWidget.item(row, 0).text())
        tipo_visita = (self.tableWidget.item(row, 1).text())
        guia = (self.tableWidget.item(row, 2).text())
        cantidad = (self.tableWidget.item(row, 3).text())
        monto = (self.tableWidget.item(row, 4).text())
